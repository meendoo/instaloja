...
//   ReactGA.initialize('UA-129407935-1');
// }
...
export default class SEO extends Component {
  ...
  defaultDescription =
    'Há mais de 15 anos oferecendo projetos com qualidade e ampliando o seu negócio.';
  defaultFullTitle = this.defaultTitle + ' | ' + this.defaultTitleAdd;
  defaultKeywords =
    'instalacoes, comerciais, vidro, temperado, farmacias, lojas, projetos, comercio, negocio, salvador, lauro de freitas, camacari, feira de santana, bahia';
  defaultType = 'website';
  render() {
